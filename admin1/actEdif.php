    ...
    <div class="row featurette">
    	<div class="col-lg-6">
          <?
            ...
            $res=mysql_query($sql);
            $edif=mysql_fetch_array($res);
          ?>
    			<h2 class='featurette-heading'><span class='text-muted'>Ingrese los datos</span></h2>
          <form action="updEdif.php" method="post">
            <div class="form-group">
              <label for="id_edificio">Identificador</label>
              <?
                echo"<input type='text' class='form-control' name='id_edificio' disabled='disabled' style='text-transform:uppercase;' maxlength='3' value='".$edif['idedificio']."' placeholder='Ej. UD1'>";
              ?>
            </div>
            <div class="form-group">
              <label for="nombre">Nombre</label>
              <?
                echo "<input type='text' class='form-control' name='nombre' maxlength='45' value='".$edif['nombre']."' placeholder='Nombre del edifico'>";
              ?>
            </div>
            <div class="form-group">
              <label for="info">Información</label>
               <?
                echo "<input type='text' class='form-control' name='info' maxlength='300' value='".$edif['informacion']."' placeholder='Información general del edificio'>";
              ?>
            </div>
