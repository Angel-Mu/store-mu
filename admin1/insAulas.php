<?
	...
	if (verificar_user()){
		...
		$sql="insert into aulas_extra(nombre,informacion,funcion,idedificio) values('$nombre','$info','$funcion','$edificio')";
		if(!mysql_query($sql)){
			echo "<script>alert('Error al insertar aula'); window.history.back();</script>";
		}else{
