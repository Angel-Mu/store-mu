  ...
  <body>
	...
	<div class="row featurette">
      ...
      ?>
          ...
          <tbody>
          <?
            while ($deptos=mysql_fetch_array($deptosTable)){
              echo "<tr>
                      <td>".$deptos['nombre']."</td>
                      <td>".$deptos['horario_atencion']."</td>
                      <td>".$deptos['info_general']."</td>
                      <td>".$deptos['idedificio']."</td>
                      <td><a class='links' href='actDeptos.php?id_depto=".$deptos['iddepartamentos']."'><span class='glyphicon glyphicon-pencil'></span></a></td>
                      <td><a class='links' href='delDeptos.php?id_depto=".$deptos['iddepartamentos']."'><span class='glyphicon glyphicon-remove'></span></a></td>
                    </tr>";
            }
          ?>
          </tbody>
        </table>
        <form action="formDeptos.php">
          <button type="submit" class="btn btn-default">Nuevo Departamento</button>
        </form>
      </div>
		</div>
