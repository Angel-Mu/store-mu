  ...
  <body>
    ...
    <div class="row featurette">
    	<div class="col-lg-6">
          ...
          <form action="insDeptos.php" method="post">
            <div class="form-group">
              <label for="nombre">Nombre</label>
              <input type="text" class="form-control" name="nombre" style="text-transform:uppercase;" maxlength="45" placeholder="Nombre del Departamento">
            </div>
            <div class="form-group">
              <label for="horario">Horario de Atención</label>
              <input type="text" class="form-control" name="horario" maxlength="100" placeholder="Horario del Departamento">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label for="info">Información General</label>
              <input type="text" class="form-control" name="info" maxlength="200" placeholder="Información general">
            </div>
