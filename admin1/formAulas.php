  ...
  <body>
    ...
    <div class="row featurette">
    	<div class="col-lg-6">
          ...
          <form action="insAulas.php" method="post">
            <div class="form-group">
              <label for="nombre">Nombre</label>
              <input type="text" class="form-control" name="nombre" style="text-transform:uppercase;" maxlength="45" placeholder="Nombre de Aula">
            </div>
            <div class="form-group">
              <label for="funcion">Función</label>
              <input type="text" class="form-control" name="funcion" maxlength="100" placeholder="Función de Aula">
            </div>
            <div class="form-group">
