  ...
  <body>
    ...
    <div class="row featurette">
    	<div class="col-lg-6">
          ...
          <form action="insOficinas.php" method="post">
            <div class="form-group">
              <label for="nombre">Nombre</label>
              <input type="text" class="form-control" name="nombre" maxlength="45" placeholder="Nombre de Oficna">
            </div>
            <div class="form-group">
              <label for="responsable">Responsable</label>
              <input type="text" class="form-control" name="responsable" maxlength="45" placeholder="Nombre del Responsable">
            </div>
            <div class="form-group">
              <label for="puesto">Puesto</label>
              <input type="text" class="form-control" name="puesto" maxlength="45" placeholder="Puesto del Responsable">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="info" maxlength="300" placeholder="Información general">
            </div>
