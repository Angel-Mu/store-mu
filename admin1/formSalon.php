  ...
  <body>
    ...
    <div class="row featurette">
      <div class="col-lg-6">
          ...
          <form action="insSalon.php"  method="post" enctype="multipart/form-data">
            <div class="form-group">
              <label for="id_salon">Identificador</label>
              <input type="text" class="form-control" name="id_salon" style="text-transform:uppercase;" maxlength="4" placeholder="Ej. A101">
            </div>
            <div class="form-group">
              <label for="capacidad">Capacidad</label>
              <input type="number" class="form-control" name="capacidad" maxlength="2" placeholder="Capacidad máxima del salón">
            </div>
            <div class="form-group">
