...
function insertar(){
	...
	i=document.getElementById('imagen').value;
	//ra=document.getElementById('ra').value;
	//i = rs.concat(ra);
	//i = document.getElementsByTagName("rutaImagen").value;
	//xml("titulo");
	...
	ajax.send("ma="+ma+"&mo="+mo+"&s="+s+"&ca="+ca+"&p="+p+"&i="+i+"&d="+d);
}
...
function actualizar(id){
	...
	ajax.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
	ajax.send("id="+id+"&ma="+ma+"&mo="+mo+"&s="+s+"&ca="+ca+"&p="+p+"&i="+i+"&d="+d);
}
